...
# 표시하도록 바뀐 것을 실행 로그(실제 구단명 목록)로 확인함(2026-09-08).
# 다른 K리그2 구단도 "대전", "안양", "포항"처럼 축약형이라 "서울"이
# 서울 이랜드를 가리키는 것으로 안전하게 판단할 수 있음.
TEAM_NAME_CANDIDATES = ["서울", "서울 이랜드", "서울이랜드FC", "서울 이랜드 FC", "서울이랜드"]
